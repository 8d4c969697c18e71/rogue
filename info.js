...
function drawInfo(){
  ...
  info.insertAdjacentHTML("beforeend", "空腹: "+player_info.hung+" / "+player_info.hung_max+"<br>");
...
function drawNote(){
  ...
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;@ ", "yellow")+": "+player.name+"<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("A-Z", "red")+": エネミー<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;0 ", "yellow")+": NPC<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;% ", "blue")+": 階段<br>");;
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;< ", "blue")+": 帰還ゲート<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;^ ", "blue")+": 罠<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;. ", "purple")+": 毒沼<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;$ ", "yellow")+": 金貨<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;) ", "yellow")+": 武器<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;[ ", "yellow")+": 鎧<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;= ", "yellow")+": 指輪<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;! ", "yellow")+": 飲み薬<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;: ", "yellow")+": 食料<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;? ", "yellow")+": 巻物<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;/ ", "yellow")+": 魔法の杖<br>");
  note.insertAdjacentHTML("beforeend", 
    colorUI("&nbsp;\" ", "yellow")+": 弾薬<br>");
  ...
  note.insertAdjacentHTML("beforeend", "- 攻撃<br>&nbsp; ←↑↓→ TO "+colorUI("A-Z", "red")+"<br>");
